...
Status: accepted; save interaction amended by ADR 0016
...
newer rescan. Configuration is written only after the Wizard's explicit Apply
action via the injected atomic save function. Setup navigation can be cancelled before save begins;
